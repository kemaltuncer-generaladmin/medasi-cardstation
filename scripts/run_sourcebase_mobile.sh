...
if [[ -x "/Volumes/driveand/Developer/flutter/bin/flutter" ]]; then
  FLUTTER_BIN="${FLUTTER_BIN:-/Volumes/driveand/Developer/flutter/bin/flutter}"
else
